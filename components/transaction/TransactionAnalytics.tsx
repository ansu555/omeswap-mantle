...
const NATIVE_SYMBOL = getChainConfig(getDefaultChainId()).chain.nativeCurrency.symbol;
...
export const TransactionAnalytics = ({
  ...
  const stats: StatItem[] = [
    {
      label: "Total Volume",
      value: `${totalVolume.toFixed(2)} ${NATIVE_SYMBOL}`,
    ...
    },
    {
      ...
      value: `${avgTransaction.toFixed(2)} ${NATIVE_SYMBOL}`,
